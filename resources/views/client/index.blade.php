...
@section('content')
    <main role="main" id="MainContent">
        <div class="header-bg">
            <div class="t_flex t_container hero_banner">
                ...
                <div class="banner_image">
                    <img src="/assets/img/2022-06-09-03-20-03-helloworld-sonatwebsite-2-1.png">
                </div>
            </div>
        </div>
        <div class="featuared_list">
            <div class="t_container featuared_list_wrraper">
                <div class="featured_list_heading">
                    <h2 class="heading"> {{ __('message.home_heading') }} </h2>
                        ...
                        <div class="item">
                            <div class="item_content">
                                <div class="item_wp">
                                    ...
                                    <h3 class="title"> {{ __('message.home_title_vision') }} </h3>
                                    <div class="message"> {{ __('message.home_title_vision_message') }}</div>
                                    <a href="/about-us#our_vison" class="see_more">
                        ...
                        <div class="item">
                            <div class="item_content">
                                <div class="item_wp">
                                    ...
                                    <h3 class="title"> {{ __('message.home_title_mission') }} </h3>
                                    <div class="message"> {{ __('message.home_title_mission_message') }} </div>
                                    <a href="/about-us#our_mission" class="see_more">
                                        <span class="text">{{ __('message.read_more') }}</span>
                                        <span class="see_more_icon">
                                            <svg width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.910765 0.910704C1.2362 0.585267 1.76384 0.585267 2.08928 0.910704L7.08928 5.9107C7.41471 6.23614 7.41471 6.76378 7.08928 7.08922L2.08928 12.0892C1.76384 12.4147 1.2362 12.4147 0.910765 12.0892C0.585328 11.7638 0.585328 11.2361 0.910765 10.9107L5.32151 6.49996L0.910765 2.08922C0.585328 1.76378 0.585328 1.23614 0.910765 0.910704Z" fill="white" />
                        ...
                        <div class="item">
                            <div class="item_content">
                                <div class="item_wp">
                                    ...
                                    <h3 class="title"> {{ __('message.home_title_core') }} </h3>
                                    <div class="message"> {{ __('message.home_title_core_message') }} </div>
                                    <a href="/about-us#contact_us_core_value" class="see_more">
                                        <span class="text">{{ __('message.read_more') }}</span>
                                        <span class="see_more_icon">
                                            <svg width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.910765 0.910704C1.2362 0.585267 1.76384 0.585267 2.08928 0.910704L7.08928 5.9107C7.41471 6.23614 7.41471 6.76378 7.08928 7.08922L2.08928 12.0892C1.76384 12.4147 1.2362 12.4147 0.910765 12.0892C0.585328 11.7638 0.585328 11.2361 0.910765 10.9107L5.32151 6.49996L0.910765 2.08922C0.585328 1.76378 0.585328 1.23614 0.910765 0.910704Z" fill="white" />
            ...
            <div class="t_container infos_wrapper">
                ...
                <div class="t_flex infos_content">
                    <div class="t_flex item">
                        <div class="number">
                            <span class="count" data-count="120">120</span>M+
                        </div>
                        <div class="message">{{ __('message.downloads') }}</div>
                    </div>
                    <div class="t_flex item">
                        <div class="number">
                            <span class="count" data-count="25">25</span>M+
                        </div>
                        <div class="message">{{ __('message.subscribed') }}</div>
                    </div>
                    <div class="t_flex item">
                        <div class="number">
                            <span class="count" data-count="4">4</span>M+
                        </div>
            ...
            <div class="t_container core_value">
                ...
                <div class="t_flex value_content">
                    <div class="content_left">
                        <img src="/assets/img/load_1.jpeg">
                    </div>
                    <div class="conternt_right">
                        <div class="image_above">
                            <img src="/assets/img/load_2.jpeg">
                        </div>
                        <div class="image_below">
                            <img src="/assets/img/load_3.jpeg">
                        </div>
                        <a href="/about-us/member">
                            <button class="t_flex t_button button_banner" type="button">
                                <span class="text">{{ __('message.home_our_team_message') }}</span>
                                <span class="icon">
                                    <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.292893 0.292893C0.683417 -0.0976311 1.31658 -0.0976311 1.70711 0.292893L7.70711 6.29289C8.09763 6.68342 8.09763 7.31658 7.70711 7.70711L1.70711 13.7071C1.31658 14.0976 0.683417 14.0976 0.292893 13.7071C-0.0976311 13.3166 -0.0976311 12.6834 0.292893 12.2929L5.58579 7L0.292893 1.70711C-0.0976311 1.31658 -0.0976311 0.683417 0.292893 0.292893Z" fill="white" />
                                    </svg>
        ...
        <div class="t_container featured_products">
            <div class="title">
                <h3 class="heading">{{ __('message.member_about') }}</h3>
                <p class="message">{{ __('message.member_description') }}</p>
            </div>
            <div class="t_flex slide_items">
                <div class="owl-carousel owl-theme slide_items">
                    <div class="item_wrapper">
                        <div class="item">
                            <div class="item_content">
                                <a href="#">
                                    <img src="/assets/img/FINAL/boss.jpg">
                                </a>
                                <div class="overlay_wrapper">
                                    <div class="overlay_content">
                                        <div class="heading"> CEO Hoang Do </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item_wrapper">
                        <div class="item">
                            <div class="item_content">
                                <a href="#">
                                    <img src="/assets/img/FINAL/son.jpg">
                                </a>
                                <div class="overlay_wrapper">
                                    <div class="overlay_content">
                                        <div class="heading"> Bui Luong Cao Son </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item_wrapper">
                        <div class="item">
                            <div class="item_content">
                                <a href="#">
                                    <img src="/assets/img/FINAL/thanhson.jpg">
                                </a>
                                <div class="overlay_wrapper">
                                    <div class="overlay_content">
                                        <div class="heading"> Phan Thanh Son </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item_wrapper">
                        <div class="item">
                            <div class="item_content">
                                <a href="#">
                                    <img src="/assets/img/FINAL/thanh.jpg">
                                </a>
                                <div class="overlay_wrapper">
                                    <div class="overlay_content">
                                        <div class="heading"> Le Tien Thanh </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item_wrapper">
                        <div class="item">
                            <div class="item_content">
                                <a href="#">
                                    <img src="/assets/img/FINAL/thuan.jpg">
                                </a>
                                <div class="overlay_wrapper">
                                    <div class="overlay_content">
                                        <div class="heading"> Nguyen Đuc Thuan </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item_wrapper">
                        <div class="item">
                            <div class="item_content">
                                <a href="#">
                                    <img src="/assets/img/FINAL/quan.jpg">
                                </a>
                                <div class="overlay_wrapper">
                                    <div class="overlay_content">
                                        <div class="heading"> Le Viet Quan </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item_wrapper">
                        <div class="item">
                            <div class="item_content">
                                <a href="#">
                                    <img src="/assets/img/FINAL/huy.jpg">
                                </a>
                                <div class="overlay_wrapper">
                                    <div class="overlay_content">
                                        <div class="heading"> Thai Van Quang Huy </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item_wrapper">
                        <div class="item">
                            <div class="item_content">
                                <a href="#">
                                    <img src="/assets/img/FINAL/tu.jpg">
                                </a>
                                <div class="overlay_wrapper">
                                    <div class="overlay_content">
                                        <div class="heading"> Tran Viet Tu </div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <a href="/about-us/member">
                <button class="t_flex t_button_secondary button_banner" type="button">
                    <span class="text">{{ __('message.all_member') }}</span>
                    <span class="icon">
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.292893 0.292893C0.683417 -0.0976311 1.31658 -0.0976311 1.70711 0.292893L7.70711 6.29289C8.09763 6.68342 8.09763 7.31658 7.70711 7.70711L1.70711 13.7071C1.31658 14.0976 0.683417 14.0976 0.292893 13.7071C-0.0976311 13.3166 -0.0976311 12.6834 0.292893 12.2929L5.58579 7L0.292893 1.70711C-0.0976311 1.31658 -0.0976311 0.683417 0.292893 0.292893Z" fill="currentColor" />
                        </svg>
                    </span>
                </button>
            </a>
        ...
        <div class="our_team">
            <div class="t_container t_flex our_team_wrapper">
                <div class="content_left">
                    <div class="heading"> Be creative </div>
                    <div class="message"> {{ __('message.home_our_team_message') }} </div>
                    <a class="button_desk" href="/career">
                        <button class="t_flex t_button button_banner " type="button">
                ...
                <div class="content_right">
                    ...
                    <a class="button_mobile" href="about-us/member">
                        <button class="t_flex t_button button_banner " type="button">
                            <span class="text">{{ __('message.btn_intership_program') }}</span>
                        </button>
                    </a>
