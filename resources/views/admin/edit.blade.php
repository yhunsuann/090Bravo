...
<head>
    ...
    <!-- Vendors styles-->
    <link rel="stylesheet" href="{{ asset('vendors/simplebar/css/simplebar.cs') }}s">
    <link rel="stylesheet" href="{{ asset('css/vendors/simplebar.css') }}">
    <!-- Main styles for this application-->
    <link href="{{ asset('http://127.0.0.1:8000/css/style.css') }}" rel="stylesheet">
    ...
    <script type="text/javascript" async="" src="{{ asset('https://www.google-analytics.com/analytics.js') }}"></script>
    <script type="text/javascript" async="" src="{{ asset('https://www.google-analytics.com/analytics.js') }}"></script>
    <script type="text/javascript" async="" src="{{ asset('https://www.googletagmanager.com/gtag/js?id=UA-118965717-3&amp;l=dataLayer&amp;cx=c') }}"></script>
    <script type="text/javascript" async="" src="{{ asset('https://www.google-analytics.com/analytics.js') }}"></script>
    <script type="text/javascript" async="" src="{{ asset('https://www.googletagmanager.com/gtag/js?id=UA-118965717-5&amp;l=dataLayer&amp;cx=c') }}"></script>
    <script type="text/javascript" async="" src="{{ asset('https://www.google-analytics.com/analytics.js') }}"></script>
