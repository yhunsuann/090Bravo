            ...
            <div class="row p-0">
                <div class="col-sm-6">
                    ...
                    <div class="datepicker date d-flex  mt-0 mx-auto">
                        ...
                        <div class="input-group">
                            <input name="dateFrom" type="text" value="{{ request()->dateFrom }}" placeholder="From date" class="form-control date-picker">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="datepicker date mx-auto d-flex">
                        ...
                        <div class="input-group">
                            <input name="dateTo" type="text" value="{{ request()->dateTo }}" placeholder="To day" class="form-control date-picker">
                            <div class="input-group-append">
                                <span class="input-group-text h-100"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div>
        ...
        <div class="col col-table px-3 bg-white" style="overflow-x:auto;">
                ...
                <thead>
                    <tr class="py-3">
                        <th class="text-center">
                            ...
                            <input type="checkbox" id="checkAll"> @else # @endif
                        </th>
            ...
            <div class="pagination--custom row">
                <div class="col-6 pagination-info">
                    @php $from = ($recruitments->currentPage() - 1) * $recruitments->perPage(); $to = $recruitments->currentPage() * $recruitments->perPage(); $total = $recruitments->total() @endphp Showing {{ $from }} to {{ $to
                    < $total ? $to : $total
