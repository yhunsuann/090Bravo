...
<div class="row">
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-primary">
            ...
            <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                <canvas class="chart" id="card-chart1" height="87" width="356" style="display: block; box-sizing: border-box; height: 69.6px; width: 284.8px;"></canvas>
                <div class="chartjs-tooltip" style="opacity: 0; left: 180.733px; top: 133.454px;">
                    <table style="margin: 0px;">
                        ...
                        <tbody class="chartjs-tooltip-body">
                            <tr class="chartjs-tooltip-body-item">
                                <td style="border-width: 0px;"><span style="background: rgb(50, 31, 219); border-color: rgba(255, 255, 255, 0.55); border-width: 2px; margin-right: 10px; height: 10px; width: 10px; display: inline-block;"></span>My First dataset: 51</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-info">
            ...
            <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                <canvas class="chart" id="card-chart2" height="87" width="356" style="display: block; box-sizing: border-box; height: 69.6px; width: 284.8px;"></canvas>
                <div class="chartjs-tooltip" style="opacity: 0; left: 295.8px; top: 128.017px;">
                    <table style="margin: 0px;">
                        <thead class="chartjs-tooltip-header">
                            <tr class="chartjs-tooltip-header-item" style="border-width: 0px;">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-warning">
            ...
            <div class="c-chart-wrapper mt-3" style="height:70px;">
                <canvas class="chart" id="card-chart3" height="87" width="396" style="display: block; box-sizing: border-box; height: 69.6px; width: 316.8px;"></canvas>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-danger">
            ...
            <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                <canvas class="chart" id="card-chart4" height="87" width="356" style="display: block; box-sizing: border-box; height: 69.6px; width: 284.8px;"></canvas>
            </div>
        </div>
    </div>
    <!-- /.col-->
