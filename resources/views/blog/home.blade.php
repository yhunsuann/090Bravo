...
<form class="mb-0" action="{{ URL::to('/blog/search') }}" method="get">
...
<form action="{{ URL::to('/blog/delete-select') }}" method="post">
    @csrf
    <div class="row my-3">
        <div class="col">
                ...
                @forelse($result as $data)
                     <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ URL::to('/blog/edit/'.$data->id)}}" type="button" class="btn-search btn btn-primary"><i class="fa fa-solid fa-wrench"></i></a>
                        </td>
                    </tr>
                    @empty
                    <td>No Data</td>
