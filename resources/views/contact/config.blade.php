...
<form class="form-create bg-white p-4" action="{{ URL::to('/contact/config/save')}}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="mb-3">
            <div class="row">
                <div class="col-2">
                    ...
                    <input type="hidden" id="contact_key" name="{{ $data->contact_key }}[contact_key]" value="{{ $data->contact_key }}">
                </div>
                @if($data->type == 'text')
                <div class="col-10">
